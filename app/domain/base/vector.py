...
from app.application.networks.embeddings import EmbeddingModelSingleton
from app.domain.exceptions import ImproperlyConfigured
from app.domain.types import DataCategory
from app.infrastructure.db.qdrant import connection
